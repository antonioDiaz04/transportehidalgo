...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-between bg-gray-100 text-white p-4 overflow-hidden">
      {/* Header with brand colors */}
        {/* <Image src="https://res.cloudinary.com/dvvhnrvav/image/upload/v1749563496/transporte/afhhpxszzwtttnfyyg6r.jpg" alt="Logo" width={280} height={100}  /> */}
  ...
  <div className="absolute right-0 top-0 w-[200%] h-[70px] bg-[#80142C] 
  ...
  <nav className="relative z-10">
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center w-full max-w-7xl gap-12 p-8 lg:pt-8 flex-grow">
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left lg:w-1/2 animate-fadeInLeft">
          <Image
            src="https://res.cloudinary.com/dvvhnrvav/image/upload/v1749563496/transporte/fkg3g8g8aofojin64fdn.jpg" // Using the same logo, but larger for impact
            alt="Gran Logo de Transporte Hidalgo"
            width={290} // Make it significantly larger
            height={250}
            className="rounded-none mb-8 "
          />
          <h1 className="text-5xl font-extrabold text-black mb-6 leading-tight drop-shadow-lg">
            Plataforma Integral de <span className="text-[#bc1c44]">Transporte Hidalgo</span>
          </h1>
